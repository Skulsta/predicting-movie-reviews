...
print(get_prediction(prepare_data('aclImdb/test/neg')[11]))
print(get_prediction(prepare_data('aclImdb/test/pos')[11]))
...
def calculate_error(folder):
    correct_prediction = 0

    if 'neg' in folder:
        for review in prepare_data(folder):
    ...
    print("------------")
    print("Predicted correctly on: " + str(correct_prediction) + " of " +
            str(len(prepare_data(folder))) + " reviews")
    print("Error rate:")
    return correct_prediction / len(prepare_data(folder))


print("Calculating negative test reviews ...")
print(calculate_error('aclImdb/test/neg'))

print("Calculating positive test reviews ...")
print(calculate_error('aclImdb/test/pos'))
